...
def mjr_addAux(
    index: int, width: int, height: int, samples: int, con: MjrContext
) -> None:
    """
...
def mjr_blitAux(
    index: int, src: MjrRect, left: int, bottom: int, con: MjrContext
) -> None:
    """
...
def mjr_blitBuffer(
    src: MjrRect, dst: MjrRect, flg_color: int, flg_depth: int, con: MjrContext
) -> None:
    """
...
def mjr_drawPixels(
    rgb: numpy.ndarray[numpy.uint8[m, 1]] | None,
    depth: numpy.ndarray[numpy.float32[m, 1]] | None,
    viewport: MjrRect,
    con: MjrContext,
) -> None:
    """
...
def mjr_readPixels(
    rgb: numpy.ndarray[numpy.uint8] | None,
    depth: numpy.ndarray[numpy.float32] | None,
    viewport: MjrRect,
    con: MjrContext,
) -> None:
    """
...
def mjr_uploadHField(
    m: mujoco._structs.MjModel, con: MjrContext, hfieldid: int
) -> None:
    """
