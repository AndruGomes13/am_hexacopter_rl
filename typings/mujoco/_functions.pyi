...
def mj_RungeKutta(
    m: mujoco._structs.MjModel, d: mujoco._structs.MjData, N: int
) -> None:
    """
...
def mj_addM(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    dst: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    rownnz: numpy.ndarray[numpy.int32[m, 1], numpy.ndarray.flags.writeable],
    rowadr: numpy.ndarray[numpy.int32[m, 1], numpy.ndarray.flags.writeable],
    colind: numpy.ndarray[numpy.int32[m, 1], numpy.ndarray.flags.writeable],
) -> None:
    """
...
def mj_applyFT(
    ...
    torque: numpy.ndarray[numpy.float64[3, 1]],
    point: numpy.ndarray[numpy.float64[3, 1]],
    body: int,
    qfrc_target: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
) -> None:
    """
...
def mj_constraintUpdate(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    jar: numpy.ndarray[numpy.float64[m, 1]],
    cost: numpy.ndarray[numpy.float64[1, 1], numpy.ndarray.flags.writeable] | None,
    flg_coneHessian: int,
) -> None:
    """
...
def mj_contactForce(
    ...
    d: mujoco._structs.MjData,
    id: int,
    result: numpy.ndarray[numpy.float64[6, 1], numpy.ndarray.flags.writeable],
) -> None:
    """
...
def mj_differentiatePos(
    m: mujoco._structs.MjModel,
    qvel: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    dt: float,
    qpos1: numpy.ndarray[numpy.float64[m, 1]],
    qpos2: numpy.ndarray[numpy.float64[m, 1]],
) -> None:
    """
...
def mj_getState(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    state: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    spec: int,
) -> None:
    """
    Get state.
...
def mj_integratePos(
    m: mujoco._structs.MjModel,
    qpos: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    qvel: numpy.ndarray[numpy.float64[m, 1]],
    dt: float,
) -> None:
    """
...
def mj_jacPointAxis(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    jacPoint: numpy.ndarray[
        numpy.float64[m, n],
        numpy.ndarray.flags.writeable,
        numpy.ndarray.flags.c_contiguous,
    ]
    | None,
    jacAxis: numpy.ndarray[
        numpy.float64[m, n],
        numpy.ndarray.flags.writeable,
        numpy.ndarray.flags.c_contiguous,
    ]
...
def mj_local2Global(
    d: mujoco._structs.MjData,
    xpos: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    xmat: numpy.ndarray[numpy.float64[9, 1], numpy.ndarray.flags.writeable],
    pos: numpy.ndarray[numpy.float64[3, 1]],
    quat: numpy.ndarray[numpy.float64[4, 1]],
    body: int,
    sameframe: int,
) -> None:
    """
...
def mj_mulJacTVec(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    res: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    vec: numpy.ndarray[numpy.float64[m, 1]],
) -> None:
    """
...
def mj_multiRay(
    m: mujoco._structs.MjModel,
    d: mujoco._structs.MjData,
    pnt: numpy.ndarray[numpy.float64[3, 1]],
    vec: numpy.ndarray[numpy.float64[m, 1]],
    geomgroup: numpy.ndarray[numpy.uint8[6, 1]] | None,
    flg_static: int,
    bodyexclude: int,
    geomid: numpy.ndarray[numpy.int32[m, 1], numpy.ndarray.flags.writeable],
    dist: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    nray: int,
    cutoff: float,
) -> None:
    """
...
def mj_objectAcceleration(
    ...
    objtype: int,
    objid: int,
    res: numpy.ndarray[numpy.float64[6, 1], numpy.ndarray.flags.writeable],
    flg_local: int,
) -> None:
    """
...
def mj_ray(
    ...
    flg_static: int,
    bodyexclude: int,
    geomid: numpy.ndarray[numpy.int32[1, 1], numpy.ndarray.flags.writeable],
) -> float:
    """
...
def mj_resetDataDebug(
    m: mujoco._structs.MjModel, d: mujoco._structs.MjData, debug_value: int
) -> None:
    """
...
def mj_resetDataKeyframe(
    m: mujoco._structs.MjModel, d: mujoco._structs.MjData, key: int
) -> None:
    """
...
def mj_rne(
    ...
    d: mujoco._structs.MjData,
    flg_acc: int,
    result: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
) -> None:
    """
...
def mj_saveModel(
    ...
    buffer: numpy.ndarray[numpy.uint8[m, 1], numpy.ndarray.flags.writeable]
    | None = None,
) -> None:
    """
...
def mj_setKeyframe(
    m: mujoco._structs.MjModel, d: mujoco._structs.MjData, k: int
) -> None:
    """
...
def mj_solveM(
    ...
    y: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.c_contiguous],
) -> None:
    """
...
def mj_solveM2(
    ...
    y: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.c_contiguous],
    sqrtInvD: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.c_contiguous],
) -> None:
    """
...
def mj_step(
    m: mujoco._structs.MjModel, d: mujoco._structs.MjData, nstep: int = 1
) -> None:
    """
...
def mjd_quatIntegrate(
    ...
    scale: float,
    Dquat: numpy.ndarray[numpy.float64[9, 1], numpy.ndarray.flags.writeable],
    Dvel: numpy.ndarray[numpy.float64[9, 1], numpy.ndarray.flags.writeable],
    Dscale: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
) -> None:
    """
...
def mjd_subQuat(
    qa: numpy.ndarray[numpy.float64[m, 1]],
    qb: numpy.ndarray[numpy.float64[m, 1]],
    Da: numpy.ndarray[
        numpy.float64[m, n],
        numpy.ndarray.flags.writeable,
        numpy.ndarray.flags.c_contiguous,
...
def mju_L1(
    vec: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
) -> float:
    """
...
def mju_add(
    res: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    vec1: numpy.ndarray[numpy.float64[m, 1]],
    vec2: numpy.ndarray[numpy.float64[m, 1]],
) -> None:
    """
    Set res = vec1 + vec2.
    """
...
def mju_add3(
    res: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    vec1: numpy.ndarray[numpy.float64[3, 1]],
    vec2: numpy.ndarray[numpy.float64[3, 1]],
) -> None:
    """
    Set res = vec1 + vec2.
    """
...
def mju_axisAngle2Quat(
    res: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable],
    axis: numpy.ndarray[numpy.float64[3, 1]],
    angle: float,
) -> None:
    """
...
def mju_band2Dense(
    ...
    mat: numpy.ndarray[numpy.float64[m, 1]],
    ntotal: int,
    nband: int,
    ndense: int,
    flg_sym: int,
...
def mju_bandMulMatVec(
    res: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    mat: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.c_contiguous],
    vec: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.c_contiguous],
    ntotal: int,
    nband: int,
    ndense: int,
    nvec: int,
...
def mju_boxQP(
    ...
    index: numpy.ndarray[numpy.int32[m, 1], numpy.ndarray.flags.writeable] | None,
    H: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.c_contiguous],
    g: numpy.ndarray[numpy.float64[m, 1]],
    lower: numpy.ndarray[numpy.float64[m, 1]] | None,
    upper: numpy.ndarray[numpy.float64[m, 1]] | None,
) -> int:
    """
...
def mju_cholFactorBand(
    mat: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    ntotal: int,
    nband: int,
    ndense: int,
    diagadd: float,
...
def mju_copy3(
    res: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    data: numpy.ndarray[numpy.float64[3, 1]],
) -> None:
    """
    Set res = vec.
    """
...
def mju_copy4(
    res: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable],
    data: numpy.ndarray[numpy.float64[4, 1]],
) -> None:
    """
    Set res = vec.
    """
...
def mju_decodePyramid(
    force: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    pyramid: numpy.ndarray[numpy.float64[m, 1]],
    mu: numpy.ndarray[numpy.float64[m, 1]],
) -> None:
    """
...
def mju_dist3(
    pos1: numpy.ndarray[numpy.float64[3, 1]], pos2: numpy.ndarray[numpy.float64[3, 1]]
) -> float:
    """
...
def mju_dot(
    vec1: numpy.ndarray[numpy.float64[m, 1]], vec2: numpy.ndarray[numpy.float64[m, 1]]
) -> float:
    """
...
def mju_dot3(
    vec1: numpy.ndarray[numpy.float64[3, 1]], vec2: numpy.ndarray[numpy.float64[3, 1]]
) -> float:
    """
    Return dot-product of vec1 and vec2.
    """
...
def mju_eig3(
    eigval: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    eigvec: numpy.ndarray[numpy.float64[9, 1], numpy.ndarray.flags.writeable],
    quat: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable],
    mat: numpy.ndarray[numpy.float64[9, 1]],
) -> int:
    """
...
def mju_encodePyramid(
    pyramid: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    force: numpy.ndarray[numpy.float64[m, 1]],
    mu: numpy.ndarray[numpy.float64[m, 1]],
) -> None:
    """
...
def mju_euler2Quat(
    quat: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable],
    euler: numpy.ndarray[numpy.float64[3, 1]],
    seq: str,
) -> None:
    """
...
def mju_f2n(
    res: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
    vec: numpy.ndarray[numpy.float32[m, 1]],
) -> None:
    """
...
def mju_fill(
    res: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable], val: float
) -> None:
    """
    Set res = val.
    """
...
def mju_insertionSort(
    list: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable],
) -> None:
    """
...
def mju_insertionSortInt(
    list: numpy.ndarray[numpy.int32[m, 1], numpy.ndarray.flags.writeable],
) -> None:
    """
...
def mju_mulMatMat(
    ...
    mat1: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.c_contiguous],
    mat2: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.c_contiguous],
) -> None:
    """
...
def mju_mulPose(
    posres: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    quatres: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable],
    pos1: numpy.ndarray[numpy.float64[3, 1]],
    quat1: numpy.ndarray[numpy.float64[4, 1]],
    pos2: numpy.ndarray[numpy.float64[3, 1]],
    quat2: numpy.ndarray[numpy.float64[4, 1]],
) -> None:
    """
    Multiply two poses.
    """
...
def mju_muscleBias(
    len: float,
    lengthrange: numpy.ndarray[numpy.float64[2, 1]],
    acc0: float,
    prm: numpy.ndarray[numpy.float64[9, 1]],
) -> float:
    """
...
def mju_muscleDynamics(
    ctrl: float, act: float, prm: numpy.ndarray[numpy.float64[3, 1]]
) -> float:
    """
...
def mju_n2f(
    res: numpy.ndarray[numpy.float32[m, 1], numpy.ndarray.flags.writeable],
    vec: numpy.ndarray[numpy.float64[m, 1]],
) -> None:
    """
...
def mju_normalize3(
    vec: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
) -> float:
    """
    Normalize vector, return length before normalization.
    """
...
def mju_normalize4(
    vec: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable],
) -> float:
    """
    Normalize vector, return length before normalization.
    """
...
def mju_printMatSparse(
    mat: numpy.ndarray[numpy.float64[m, 1]],
    rownnz: numpy.ndarray[numpy.int32[m, 1]],
    rowadr: numpy.ndarray[numpy.int32[m, 1]],
    colind: numpy.ndarray[numpy.int32[m, 1]],
) -> None:
    """
...
def mju_quat2Mat(
    res: numpy.ndarray[numpy.float64[9, 1], numpy.ndarray.flags.writeable],
    quat: numpy.ndarray[numpy.float64[4, 1]],
) -> None:
    """
...
def mju_rayFlex(
    ...
    pnt: float,
    vec: float,
    vertid: numpy.ndarray[numpy.int32[1, 1], numpy.ndarray.flags.writeable],
) -> float:
    """
...
def mju_springDamper(
    pos0: float, vel0: float, Kp: float, Kv: float, dt: float
) -> float:
    """
...
def mju_sqrMatTD(
    ...
    mat: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.c_contiguous],
    diag: numpy.ndarray[numpy.float64[m, 1], numpy.ndarray.flags.writeable] | None,
) -> None:
    """
...
def mju_subQuat(
    res: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    qa: numpy.ndarray[numpy.float64[4, 1]],
    qb: numpy.ndarray[numpy.float64[4, 1]],
) -> None:
    """
...
def mju_transformSpatial(
    res: numpy.ndarray[numpy.float64[6, 1], numpy.ndarray.flags.writeable],
    vec: numpy.ndarray[numpy.float64[6, 1]],
    flg_force: int,
    newpos: numpy.ndarray[numpy.float64[3, 1]],
    oldpos: numpy.ndarray[numpy.float64[3, 1]],
    rotnew2old: numpy.ndarray[numpy.float64[9, 1]],
) -> None:
    """
...
def mjv_alignToCamera(
    res: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    vec: numpy.ndarray[numpy.float64[3, 1]],
    forward: numpy.ndarray[numpy.float64[3, 1]],
) -> None:
    """
...
def mjv_cameraInModel(
    headpos: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    forward: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    up: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    scn: mujoco._structs.MjvScene,
) -> None:
    """
...
def mjv_connector(
    ...
    type: int,
    width: float,
    from_: numpy.ndarray[numpy.float64[3, 1]],
    to: numpy.ndarray[numpy.float64[3, 1]],
) -> None:
    """
...
def mjv_initGeom(
    ...
    pos: numpy.ndarray[numpy.float64[3, 1]],
    mat: numpy.ndarray[numpy.float64[9, 1]],
    rgba: numpy.ndarray[numpy.float32[4, 1]],
) -> None:
    """
...
def mjv_model2room(
    roompos: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    roomquat: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable],
    modelpos: numpy.ndarray[numpy.float64[3, 1]],
    modelquat: numpy.ndarray[numpy.float64[4, 1]],
    scn: mujoco._structs.MjvScene,
) -> None:
    """
...
def mjv_moveModel(
    ...
    reldx: float,
    reldy: float,
    roomup: numpy.ndarray[numpy.float64[3, 1]],
    scn: mujoco._structs.MjvScene,
) -> None:
    """
...
def mjv_room2model(
    modelpos: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    modelquat: numpy.ndarray[numpy.float64[4, 1], numpy.ndarray.flags.writeable],
    roompos: numpy.ndarray[numpy.float64[3, 1]],
    roomquat: numpy.ndarray[numpy.float64[4, 1]],
    scn: mujoco._structs.MjvScene,
) -> None:
    """
...
def mjv_select(
    ...
    rely: float,
    scn: mujoco._structs.MjvScene,
    selpnt: numpy.ndarray[numpy.float64[3, 1], numpy.ndarray.flags.writeable],
    geomid: numpy.ndarray[numpy.int32[1, 1], numpy.ndarray.flags.writeable],
    flexid: numpy.ndarray[numpy.int32[1, 1], numpy.ndarray.flags.writeable],
    skinid: numpy.ndarray[numpy.int32[1, 1], numpy.ndarray.flags.writeable],
) -> int:
    """
