...
import typing
__all__ = ['Collision', 'Data', 'GeomInfo', 'Model', 'collider', 'jax', 'jp', 'math']
def _plane_sphere(plane_normal: jax.Array, plane_pos: jax.Array, sphere_pos: jax.Array, sphere_radius: jax.Array) -> typing.Tuple[jax.Array, jax.Array]:
    """
    Returns the distance and contact point between a plane and sphere.
    """
def _sphere_sphere(pos1: jax.Array, radius1: jax.Array, pos2: jax.Array, radius2: jax.Array) -> typing.Tuple[jax.Array, jax.Array, jax.Array]:
    """
