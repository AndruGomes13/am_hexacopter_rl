...
__all__ = ['Data', 'ET', 'benchmark', 'create_mjcf', 'efc_order', 'epath', 'forward', 'io', 'jax', 'load_test_file', 'mujoco', 'np', 'os', 'p', 'sys', 'time']
def _geom_solparams(pair: bool = False, enable_contact: bool = True) -> typing.Dict[str, str]:
    """
    Returns geom solver parameters.
    """
def _make_actuator(actuator_type: str, joint: typing.Optional[str] = None, site: typing.Optional[str] = None, refsite: typing.Optional[str] = None) -> typing.Dict[str, str]:
    """
    Returns attributes for an actuator.
    """
def _make_geom(pos: str, size: float, name: str, enable_contact: bool = True) -> typing.Dict[str, str]:
    """
...
def _measure(fn, *args) -> typing.Tuple[float, float]:
    ...
    """
def benchmark(m: mujoco._structs.MjModel, nstep: int = 1000, batch_size: int = 1024, unroll_steps: int = 1, solver: str = 'newton', iterations: int = 1, ls_iterations: int = 4) -> typing.Tuple[float, float, int]:
    """
    Benchmark a model.
    """
def create_mjcf(seed: int, min_trees: int = 1, max_trees: int = 1, max_tree_depth: int = 5, body_pos: typing.Tuple[float, float, float] = (0.0, 0.0, -0.5), geom_pos: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), max_stacked_joints = 4, max_geoms_per_body = 2, max_contact_excludes = 1, max_contact_pairs = 4, disable_actuation_pct: int = 0, add_actuators: bool = False, root_always_free: bool = False, enable_contact: bool = True) -> str:
    ...
    """
def efc_order(m: mujoco._structs.MjModel, d: mujoco._structs.MjData, dx: mujoco.mjx._src.types.Data) -> numpy.ndarray:
    """
...
_SOLIMPS: list = ['0.75 0.94 0.002 0.2 2', '0.8 0.99 0.001 0.3 6', '0.6 0.9 0.003 0.1 1']
