# config.py
import math
from environments.hexcopter.action_models import ActionModelType
from environments.hexcopter.observation_models import ActorObservationType, CriticObservationType
import numpy as np
...
class Schedule(BaseModel):
    ...
    p_range: Tuple[float, float] = (0.0, 1.0)  # progress ∈ [s,e]
...
class DomainRandomizationConfig(BaseModel):
    ...
    drone_mass_mult_range: Tuple[float, float] = (0.95, 1.05) # Multiplier
    contact_solref_damping_range: Tuple[float, float] = (-10.0, -15.0)
...
class EnvConfig(BaseModel):
    ...
    action_model: ActionModelType = ActionModelType.NORM_THRUST_BODY_RATE
    # action_model: ActionModelType = ActionModelType.THRUST_TORQUE
    # action_model: ActionModelType = ActionModelType.DIRECT_PROP
